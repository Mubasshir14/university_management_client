...
import { getStudentByDepartment } from "../Services/Student";
import {
  Table,
  TableBody,
  TableCell,
...
const FilterStudentByDepartment = () => {
  ...
  return (
    <section className="py-10 font-sansita">
      <Department onSelect={setSelectedDepartmentId} />
        ...
        <div className="mt-10 px-4">
          {isLoading ? (
            ...
            >
              ...
              <p className="mt-1 text-sm text-gray-500">Fetching data for the selected department</p>
            </motion.div>
          ) : students.length === 0 ? (
            <motion.div
...
export default FilterStudentByDepartment;