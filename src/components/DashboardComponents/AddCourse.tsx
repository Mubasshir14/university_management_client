  ...
  const onSubmit: SubmitHandler<FieldValues> = async (data) => {
    ...
    try {
      ...
      if (res.success) {
        ...
        toast.error(res.message || "Failed to add course", { id: toastId });
      }
    } catch (err: any) {
                        ...
                        <FormItem>
                          ...
                          <FormControl>
                            <Input
                              type="number"
                              placeholder="e.g., 3"
                              className="bg-white/5 border-gray-600 t placeholder-gray-400 focus:ring-2 focus:ring-blue-600 rounded-lg bg-clip-text text-transparent bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600"
                              {...field}
                              value={field.value || ""}
                            />
                          </FormControl>
                        ...
                        <FormItem>
                          ...
                          <FormControl>
                            <Select
                              ...
                              className="bg-white/5  rounded bg-clip-text text-transparent bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600"
                              classNamePrefix="react-select"
                              onChange={(selected) =>
                                field.onChange(selected.map((s) => s.value))
                              }
